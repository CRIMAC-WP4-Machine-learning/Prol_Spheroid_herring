...
class UserDefinedSettings:
    ...
    def __init__(self):
        self.prefix = 'ShrimpC'        # just a name to identify the output files
        # media properties
        self.ro_w = 1027            # the density of the surrounding media [kg/m^3]
        self.ro_s = 1027 * 1.0257            # the density of the spheroid [kg/m^3]
        self.c_w = 1500             # the sound speed in the surrounding media [m/s]
        self.c_s = 1500 * 1.044            # the sound speed in the spheroid [m/s]
